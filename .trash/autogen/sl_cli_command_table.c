...
static const sl_cli_command_info_t cli_cmd_ota_hyphen_bootload_info = \
  SL_CLI_COMMAND(printBootloaderInfoCommand,
                 "Prints info about the installed bootloader.",
                  "",
                 {SL_CLI_ARG_END, });
...
static const sl_cli_command_entry_t ota_hyphen_bootload_group_table[] = {
  { "info", &cli_cmd_ota_hyphen_bootload_info, false },
  { NULL, NULL, false },
};
static const sl_cli_command_info_t cli_cmd_grp_ota_hyphen_bootload = \
  SL_CLI_COMMAND_GROUP(ota_hyphen_bootload_group_table, "ota-bootload related commands");
...
static const sl_cli_command_entry_t plugin_group_table[] = {
  ...
  { "ota-bootload", &cli_cmd_grp_ota_hyphen_bootload, false },
