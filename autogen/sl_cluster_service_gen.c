...
extern uint32_t emberAfIdentifyClusterClientCommandParse(sl_service_opcode_t opcode,
                                                sl_service_function_context_t *context);
extern uint32_t emberAfGroupsClusterClientCommandParse(sl_service_opcode_t opcode,
                                                sl_service_function_context_t *context);
...
extern uint32_t emberAfScenesClusterServerCommandParse(sl_service_opcode_t opcode,
                                                sl_service_function_context_t *context);
extern uint32_t emberAfScenesClusterClientCommandParse(sl_service_opcode_t opcode,
                                                sl_service_function_context_t *context);
extern uint32_t emberAfZllOnOffClusterServerCommandParse(sl_service_opcode_t opcode,
                                                sl_service_function_context_t *context);
extern uint32_t emberAfZllScenesClusterClientCommandParse(sl_service_opcode_t opcode,
                                                sl_service_function_context_t *context);
extern uint32_t emberAfZllCommissioningClusterClientCommandParse(sl_service_opcode_t opcode,
                                                sl_service_function_context_t *context);
...
const sl_service_function_entry_t sli_cluster_service_entries[] = {
  ...
  { SL_SERVICE_FUNCTION_TYPE_ZCL_COMMAND, 0x0003, (NOT_MFG_SPECIFIC | (SL_CLUSTER_SERVICE_SIDE_CLIENT << 16)), emberAfIdentifyClusterClientCommandParse },
  { SL_SERVICE_FUNCTION_TYPE_ZCL_COMMAND, 0x0004, (NOT_MFG_SPECIFIC | (SL_CLUSTER_SERVICE_SIDE_CLIENT << 16)), emberAfGroupsClusterClientCommandParse },
...
//  { SL_SERVICE_FUNCTION_TYPE_ZCL_COMMAND, 0x0006, (NOT_MFG_SPECIFIC | (SL_CLUSTER_SERVICE_SIDE_SERVER << 16)), emberAfOnOffClusterServerCommandParse },
  ...
  { SL_SERVICE_FUNCTION_TYPE_ZCL_COMMAND, 0x0005, (NOT_MFG_SPECIFIC | (SL_CLUSTER_SERVICE_SIDE_CLIENT << 16)), emberAfScenesClusterClientCommandParse },
  { SL_SERVICE_FUNCTION_TYPE_ZCL_COMMAND, 0x0005, (NOT_MFG_SPECIFIC | (SL_CLUSTER_SERVICE_SIDE_CLIENT << 16)), emberAfZllScenesClusterClientCommandParse },
//  { SL_SERVICE_FUNCTION_TYPE_ZCL_COMMAND, 0x0006, (NOT_MFG_SPECIFIC | (SL_CLUSTER_SERVICE_SIDE_SERVER << 16)), emberAfZllOnOffClusterServerCommandParse },
  { SL_SERVICE_FUNCTION_TYPE_ZCL_COMMAND, 0x1000, (NOT_MFG_SPECIFIC | (SL_CLUSTER_SERVICE_SIDE_CLIENT << 16)), emberAfZllCommissioningClusterClientCommandParse },
  };
