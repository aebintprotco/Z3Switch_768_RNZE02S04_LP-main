...
#define EMBER_AF_PLUGIN_OTA_CLIENT_POLICY_IMAGE_TYPE_ID   10204
...
#define EMBER_AF_PLUGIN_OTA_CLIENT_POLICY_FIRMWARE_VERSION   VERSION
...
#define EMBER_AF_PLUGIN_OTA_CLIENT_POLICY_HARDWARE_VERSION   XYZ_VERSION(1,0,0)
