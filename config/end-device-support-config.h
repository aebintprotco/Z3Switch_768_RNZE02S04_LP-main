...
#define EMBER_AF_PLUGIN_END_DEVICE_SUPPORT_LONG_POLL_INTERVAL_SECONDS   HEARBEAT_TIME
...
// <o EMBER_AF_PLUGIN_END_DEVICE_SUPPORT_WAKE_TIMEOUT_BITMASK> Wake Timeout Bitmask (hex) <0-4294967295>
